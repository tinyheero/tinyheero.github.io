...
Mathematically, a GMM can be represented like this:

$$ p(x) = \sum_{k=1}^{K}\pi_k\mathcal{N}(x|\mu_{k},\sigma_{k}) $$ 

## Implementing Your Own GMM In R 

If you are like me, then not knowing what is happening "under the hood" may bug you. What is actually happening when I run `normalmixEM`? How does it fit the components?
