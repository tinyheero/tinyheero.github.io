...
* It has no upper bound. In other words, unlike <span class="inlinecode">$S(t)$</span>, which is a probability, the <span class="inlinecode">$h(t)$</span> can be > 1 and can go up to <span class="inlinecode">$\infinity$</span>.
