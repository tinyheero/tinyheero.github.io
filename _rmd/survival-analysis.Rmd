...
What this tell us is as <span class="inlinecode">$\Delta t$</span> approaches 0 (i.e. as the time interval approaches 0), then the hazard function equals a survival probability statement divided by <span class="inlinecode">$\Delta t$</span>.

Essentially what this equation indicates is the **instantaneous potential at a given time for the event to occur, given that the individual has survived up to time t.**
