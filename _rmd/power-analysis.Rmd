...
Power calculations are always in the context of hypothesis testing.
...
pwr.t2n.test.res.list.df %>%
  ...
  ylab("Effect Size") +
  geom_text(aes(x = 950, y = 0.25, label = "Small Effect")) +
  geom_text(aes(x = 950, y = 0.55, label = "Medium Effect")) +
  geom_text(aes(x = 950, y = 0.85, label = "Large Effect"))
```
