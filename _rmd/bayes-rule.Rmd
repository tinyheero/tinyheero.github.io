...
So what does this mean? What this rule gives us is a way to relate our "prior probability" of the hypothesis <span class="inlinecode">$P(H)$</span> to our "updated probability" of the hypothesis <span class="inlinecode">$P(H\ |\ E)$</span> once we have some data to consider. This "updated belief" is called the posterior. 

Let's see this in action. Say we are playing cards and we have a prior probability that there is a 1/13 chance of getting a King card. But now say, we also have the data that the card we have in hand is a "face" card (i.e. Jack, Queen, King). What then is the probability of getting a King? Let's break down the individual components of Bayes' rule here:

* P(H) = There is a King in each suit, and there are 4 suits. Hence this is 4 / 52 = 1 / 13
* P(E) = As there are 3 face cards per suit and there are 4 suits, then this is 12 / 52 = 3 / 13
...
<div>
$$P(H\ |\ E) = \frac{1 * 1/13}{3 / 13}$$
</div>

## An Example of Using Bayes Rule

Let's say we start with the hypothesis that 


 The rule doesn't seem to be that interestingly at first glance, but we will see below with some examples why it is actually really important.
