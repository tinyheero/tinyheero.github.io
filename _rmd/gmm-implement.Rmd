...
```{r echo = FALSE}
library("knitr")
knitr::opts_chunk$set(fig.path="{{ site.url }}/assets/gmm-implement/")
```
...
```{r parameter_est_complete_data, dev = "svg", message = FALSE}
library("ggplot2")
library("dplyr")
library("reshape2")
...
```{r parameter_est_incomplete_data, dev = "svg", message = FALSE}
vals.df %>%
