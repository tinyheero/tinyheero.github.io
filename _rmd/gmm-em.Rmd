...
* 13-12-2017 - Fixed math symbol for variance (<span class="inlinecode">$\sigma^{2}$</span>) across various equations. Was using accidentally using <span class="inlinecode">$\sigma$</span> instead. Thanks [Eric](https://disqus.com/by/disqus_K31aw7ERi7) for pointing this out!
